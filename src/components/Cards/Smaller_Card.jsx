...
const Smaller_Card = ({ title, rating, price, image }) => {
  return (
    <div className="bg-transparent text-white rounded-lg shadow-lg overflow-hidden w-[300px] mx-4">
      <img src={image} alt="Gig" className="w-full h-[250px] object-cover" />
